...
PAYMENT_PROVIDERS: dict = {
    ...
    "efectivo": {
        ...
        "config_fields": [],
        "icon": "💵",
        "logo_url": None,  # genérico, usamos icon
        "logo_domain": None,
        "color": "#16a34a",
    ...
    "mercadopago": {
        ...
        "icon": "💙",
        "logo_url": "https://www.mercadopago.com/favicon.ico",
    ...
    "pix": {
        ...
        "icon": "⚡",
        "logo_url": "https://upload.wikimedia.org/wikipedia/commons/a/a2/Logo%E2%80%94pix_powered_by_Banco_Central_%28Brazil%2C_2020%29.svg",
        "logo_domain": "bcb.gov.br",
        "color": "#32bcad",
