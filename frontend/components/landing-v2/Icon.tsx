...
export type IconName =
  | "bolt" | "chat" | "cart" | "chart" | "box" | "globe" | "shield"
  | "clock" | "check" | "arrow" | "sparkle" | "layers" | "users"
  | "truck" | "store" | "coffee" | "scissors" | "book" | "home"
  | "search" | "settings" | "inbox" | "tag";
...
export default function Icon({ name, size = 20, ...rest }: IconProps) {
  ...
  switch (name) {
    ...
    case "chart":
      return <svg {...common}><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /><line x1="3" y1="20" x2="21" y2="20" /></svg>;
    case "box":
    ...
    case "globe":
      return <svg {...common}><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15 15 0 0 1 4 10 15 15 0 0 1-4 10 15 15 0 0 1-4-10 15 15 0 0 1 4-10z" /></svg>;
    case "shield":
    ...
    case "store":
      return <svg {...common}><path d="M3 9l2-5h14l2 5" /><path d="M3 9v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9" /><path d="M3 9a3 3 0 0 0 6 0 3 3 0 0 0 6 0 3 3 0 0 0 6 0" /></svg>;
    case "coffee":
    ...
    case "scissors":
      return <svg {...common}><circle cx="6" cy="6" r="3" /><circle cx="6" cy="18" r="3" /><line x1="20" y1="4" x2="8.12" y2="15.88" /><line x1="14.47" y1="14.48" x2="20" y2="20" /><line x1="8.12" y1="8.12" x2="12" y2="12" /></svg>;
    case "book":
