  ...
  return (
    <div className="min-h-screen bg-background landing-bg flex items-center justify-center">
      <div className="w-full max-w-md p-8 rounded-2xl glass">
        ...
        <h1 className="heading-page text-2xl mb-2">Iniciar sesión</h1>
        <p className="text-text-muted text-sm mb-6">
          Accede a tu panel de Nexora
        </p>
          ...
          {(error || oauthError) && (
            <div className={`p-3 rounded-lg text-sm ${
              ...
              {error || 
                ...
                (oauthError === "oauth_token_failed" ? "Error al intercambiar el código de Google. Verifica el redirect URI en Google Cloud Console." : "") ||
                (oauthError === "google_not_configured" ? "Google no está configurado. Usa tu email y contraseña para entrar." : "")}
            </div>
          )}
          <div>
